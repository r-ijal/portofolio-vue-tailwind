      ...
      <div class="flex flex-wrap">
        <div class="w-full self-center px-4 lg:w-1/2">
          ...
          <p class="font-medium text-secondary mb-10 leading-relaxed">
            ...
            sequi inventore voluptas magni rem nam cumque quaerat velit maiores.
            In.
          </p>
      ...
      <div class="flex flex-wrap">
        <div class="w-full px-4 mb-10 lg:w-1/2">
          ...
          <p class="font-medium text-base text-secondary max-w-xl lg:text-lg">
            ...
            accusamus fugiat ipsa, aliquam voluptate dicta perspiciatis velit
            repudiandae neque iste?
          </p>
        </div>
        <div class="w-full px-4 lg:w-1/2">
          ...
          <p class="font-medium text-base text-secondary mb-4 lg:text-lg">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam
            ipsam exercitationem maxime animi magni praesentium, at laudantium
            aliquid, saepe sint accusamus corporis distinctio nobis porro
            architecto? Aut quisquam repellat quas?
          </p>
          <div class="flex items-center">
            <!-- Youtube -->
            <a
              href="https://youtube.com/r3dlabelz"
              target="_blank"
            ...
            <!-- Instagram -->
            <a
              href="https://instagram.com/r_ijal"
              target="_blank"
              class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
            >
              <svg
      ...
      <div class="w-full px-4">
        <div class="max-w-xl mx-auto text-center mb-16">
          ...
          <p class="font-medium text-md text-secondary md:text-lg">
            ...
            optio temporibus provident sapiente accusamus ut nam quibusdam neque
            minima animi blanditiis perspiciatis, fugit, dolor pariatur.
          </p>
        </div>
      </div>
      <div class="w-full px-4 flex flex-wrap justify-center">
        <div class="mb-12 p-4 md:w-1/2">
          <div class="rounded-md shadow-md overflow-hidden">
            <img
              src="../assets/portofolio/ss_landing.png"
              alt="random 2"
              width="w-full"
            />
          </div>
          ...
          <p class="font-medium text-base text-secondary">
            ...
            vitae unde quasi, deserunt eos cumque inventore quaerat.
          </p>
        </div>
        <div class="mb-12 p-4 md:w-1/2">
          <div class="rounded-md shadow-md overflow-hidden">
            <img
              src="../assets/portofolio/ss_simpus.png"
              alt="simpus kudus"
              width="w-full"
            />
          </div>
        ...
        <div class="mb-12 p-4 md:w-1/2">
          <div class="rounded-md shadow-md overflow-hidden">
            <img
              src="../assets/portofolio/ss_barberia.png"
              alt="hr barberia"
              width="w-full"
            />
          </div>
        ...
        <div class="mb-12 p-4 md:w-1/2">
          <div class="rounded-md shadow-md overflow-hidden">
            <img
              src="../assets/portofolio/ss_random_1.png"
              alt=" random 1"
              width="w-full"
            />
          </div>
        ...
        <div class="mb-12 p-4 md:w-1/2">
          <div class="rounded-md shadow-md overflow-hidden">
            <img
              src="../assets/portofolio/ss_random_2.png"
              alt="random 2"
              width="w-full"
            />
          </div>
        ...
        <div class="mb-12 p-4 md:w-1/2">
          <div class="rounded-md shadow-md overflow-hidden">
            <img
              src="../assets/portofolio/ss_vuetify.png"
              alt="random 2"
              width="w-full"
            />
          </div>
    ...
    <div class="container">
      <div class="flex flex-wrap">
        <div class="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
          <h2 class="font-bold text-4xl text-white mb-5">Fosan</h2>
          <h3 class="font-bold text-2xl mb-2">Hubungi Kami</h3>
          <p>adminfosan@fosan.id</p>
          <p>Jl. Karangrejo No. 60A</p>
          <p>Semarang</p>
        </div>
      ...
      <div class="w-full pt-10 border-t border-slate-800">
        ...
        <p class="font-medium text-xs text-slate-500 text-center">
          Dibuat dengan <span class="text-primary">❤️</span> oleh
          <a
            href="https://instagram.com/r_ijal"
            target="_blank"
